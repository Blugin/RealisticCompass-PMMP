...
class CheckUpdateAsyncTask extends AsyncTask{
	...
	private const RELEASE_URL = "https://api.github.com/repos/PresentKim/RealisticCompass-PMMP/releases/latest";
	...
	public function __construct(){
		$this->cachePath = RealisticCompass::getInstance()->getDataFolder() . ".latestCache";
	}
	...
	public function onCompletion(Server $server) : void{
		$plugin = RealisticCompass::getInstance();
